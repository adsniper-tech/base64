...
static inline __m256i
enc_translate2 (const __m256i in)
{
    // LUT contains Absolute offset for all ranges:
    const __m256i lut = _mm256_setr_epi8(65, 71, -4, -4, -4, -4, -4, -4, -4, -4, -4, -4, -17, 32, 0, 0,
